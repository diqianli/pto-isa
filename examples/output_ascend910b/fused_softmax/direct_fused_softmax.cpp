...
class direct_fused_softmaxKernel {
public:
    __aicore__ inline direct_fused_softmaxKernel() {}
...
extern "C" __global__ __aicore__ void direct_fused_softmax_kernel(GM_ADDR input, GM_ADDR output) {
    direct_fused_softmaxKernel op;
